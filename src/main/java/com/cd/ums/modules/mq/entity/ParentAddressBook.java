 ...
 * @version 2018-10-16
 */
public class ParentAddressBook extends DataEntity<ParentAddressBook> {
	...
	public ParentAddressBook() {
		super();
	}

	public ParentAddressBook(String id){
		super(id);
	}

	@Length(min=0, max=64, message="单位编码长度必须介于 0 和 64 之间")
