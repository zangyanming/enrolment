 ...
 * @version 2018-11-01
 */
public class SysLogWx extends DataEntity<SysLogWx> {
	...
	private String sendOfficeId;		// 微信发送者单位
	private String sendBy;		// 微信发送者
	private String receiveBy;		// 微信接收者
	...
	@Length(min=0, max=64, message="微信发送者单位长度必须介于 0 和 64 之间")
	public String getSendOfficeId() {
		return sendOfficeId;
	}

	public void setSendOfficeId(String sendOfficeId) {
		this.sendOfficeId = sendOfficeId;
	}
	
	@Length(min=0, max=64, message="微信发送者长度必须介于 0 和 64 之间")
