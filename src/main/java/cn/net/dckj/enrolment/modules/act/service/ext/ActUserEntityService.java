...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new cn.net.dckj.enrolment.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new cn.net.dckj.enrolment.modules.sys.entity.User(null, userId)))){
