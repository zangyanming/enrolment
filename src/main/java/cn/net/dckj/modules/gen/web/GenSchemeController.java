 ...
 */
package cn.net.dckj.modules.gen.web;
...
import cn.net.dckj.modules.gen.entity.GenScheme;
import cn.net.dckj.modules.gen.service.GenSchemeService;
import cn.net.dckj.modules.gen.service.GenTableService;
import cn.net.dckj.modules.gen.util.GenUtils;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("cn.net.dckj.enrolment.modules");
		}
