...
<head>
	...
	<style type="text/css">
		...
		#header {position:absolute;top:-4rem;} #header li {font-size:14px;_font-size:12px;}
	...
	<div id="main">
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
						...
						<c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
							<c:if test="${menu.parent.id eq '1'&& menu.isShow eq '1' && menu.name eq '系统设置'}">
	    ...
	    <div class="container-fluid">
		    ...
		    <%--<div id="footer" class="row-fluid">--%>
	            <%--&lt;%&ndash;Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://ums.com" target="_blank">Ums</a> ${fns:getConfig('version')}&ndash;%&gt;--%>
			<%--</div>--%>
		</div>
	</div>
	<script type="text/javascript"> 
