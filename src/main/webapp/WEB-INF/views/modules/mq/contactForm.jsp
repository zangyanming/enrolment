...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/mq/contact/">联系人列表</a></li>
		<li class="active"><a href="${ctx}/mq/contact/form?id=${contact.id}">联系人<shiro:hasPermission name="mq:contact:edit">${not empty contact.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="mq:contact:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="contact" action="${ctx}/mq/contact/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">联系人来源类型：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">来源表的ID：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="mq:contact:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
